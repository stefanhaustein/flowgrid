...
public class SwtApiSetup  extends Callback<Model> {

    private final SwtFlowgrid platform;

    public SwtApiSetup(SwtFlowgrid platform) {
    ...
    public void run(Model model) {
        try {
            ...
            Classifier canvasClass = graphicsModule.addJavaClass("Canvas", CanvasControl.class);
