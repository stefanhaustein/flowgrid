...
public class SplitPaneLayout extends ViewGroup {
        ...
        private boolean mAutoOrientation = false;
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (widthSize > 0 && heightSize > 0) {
                  if (mAutoOrientation) {
                    mOrientation = widthSize >= heightSize ? ORIENTATION_HORIZONTAL : ORIENTATION_VERTICAL;
                  }
        ...
        public void setmAutoOrientation(boolean ao) {
                mAutoOrientation = ao;
        }
